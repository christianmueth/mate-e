        ...
        <div className="rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-700">Inspect the bounded cross-surface workspace context that now feeds guidance continuity and recommendation carry-over.</p>
            </div>
