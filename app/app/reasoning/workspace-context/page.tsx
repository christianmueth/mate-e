    ...
    <main className="mx-auto max-w-5xl space-y-6 px-6 py-8">
      <section className="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:flex-row md:items-end md:justify-between">
        <div className="space-y-3">
          ...
          <p className="text-sm leading-7 text-slate-600">
            This surface shows the latest persisted cross-surface workspace context. It is intentionally bounded to the active workspace thread, current workspace artifacts, and recent guidance continuity.
          </p>
        </div>
      ...
      {latest.context ? (
        <div className="grid gap-6 xl:grid-cols-2">
          ...
          <InspectorCard title="Guidance memory" value={latest.context.tutorMemory} />
          ...
          <InspectorCard title="Recent guidance interactions" value={latest.context.recentTutorInteractions} />
        ...
        <section className="rounded-3xl border border-dashed border-slate-300 bg-white p-6 text-sm leading-7 text-slate-600 shadow-sm">
          No persisted workspace context has been written for this operator account yet. Open a workspace session or workspace tool to seed the shared context.
        </section>
      )}
